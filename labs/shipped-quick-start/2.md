...
1. Enter your new project name, **MyFirstShippedProject** for example, then click **Start Composing**.  
    ...
    ![](posts/files/shipped-quick-start/assets/images/create-first-project.png)

    The **Compose Your Project** page opens, displaying your project name.

	![](posts/files/shipped-quick-start/assets/images/compose-project-service.png)
...
4. Select **golang** buildpack for this example.
    ...
    ![](posts/files/shipped-quick-start/assets/images/compose-project.png)

4. Enter **goHelloWorld** for the service name. 

	![](posts/files/shipped-quick-start/assets/images/golang.png)
...
5. Select the Github Organization (it's your account by default), then click **Add Service**. 
    ...
    ![](posts/files/shipped-quick-start/assets/images/golang-hello-world.png)

6. Click  **Save Project**.  
    Your Shipped project is now created and displayed.

    ![](posts/files/shipped-quick-start/assets/images/save-project.png)

6. To add multiple services, click **Build**, then follow steps 2 through 6 above. 

    ![](posts/files/shipped-quick-start/assets/images/create-mulit-services.png)
