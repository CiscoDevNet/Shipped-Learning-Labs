...
2. Select a project from **Your Projects** drop-down list, or create a new one.
    ...
    ![](posts/files/shipped-cicd/assets/images/project-select.png)

3. Add a new service (Golang for example).

    ![](posts/files/shipped-cicd/assets/images/2.PNG)

4. Enter a name for this service.

    ![](posts/files/shipped-cicd/assets/images/3.PNG)

5. Click **Save Project**.  
    A new git repo is created with the service name you created.

    ![](posts/files/shipped-cicd/assets/images/4.PNG)
...
6. Verify the build.   
    ...
    ![](posts/files/shipped-cicd/assets/images/5.PNG)
  
7.  Click the **Deploy** tab then click **New Environment**.

    ![](posts/files/shipped-cicd/assets/images/Environment-add.png)    

8.  Enter a name for the environment, click **Save**. 

9.  Click **Deploy Build**.
    
    ![](posts/files/shipped-cicd/assets/images/12.PNG)    
