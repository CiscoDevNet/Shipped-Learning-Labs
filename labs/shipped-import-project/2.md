...
1. Compose a new project to integrate to your repository.
    ...
    ![](posts/files/shipped-import-project/assets/images/4.PNG)

1. Click **Add an existing repository**.

3. Type the name of the existing repo you want to import, press **Enter**.

    ![](posts/files/shipped-import-project/assets/images/5.PNG)

1. Click **Save Project**.

    ![](posts/files/shipped-import-project/assets/images/6.PNG)
