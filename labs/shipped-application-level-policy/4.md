...
![](posts/files/shipped-application-level-policy/assets/images/13.PNG)
...
![](posts/files/shipped-application-level-policy/assets/images/14.PNG)
...
![](posts/files/shipped-application-level-policy/assets/images/15.PNG)

After reach to threshold we have stopped memory leak and capture the below output.

![](posts/files/shipped-application-level-policy/assets/images/16.PNG)


Below are the related metrics graphs

![](posts/files/shipped-application-level-policy/assets/images/17.PNG)
