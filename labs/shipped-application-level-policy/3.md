...
Your app started running.
    ...
    ![](posts/files/shipped-application-level-policy/assets/images/5.PNG)

1. Click **Settings** then click  **Alerting Thresholds**.

    ![](posts/files/shipped-application-level-policy/assets/images/6.PNG)

1. Scroll down and click **Add New Policy**.

    ![](posts/files/shipped-application-level-policy/assets/images/7.PNG)

1. Enter a name for the policy.

    ![](posts/files/shipped-application-level-policy/assets/images/8.PNG)

1. Select a metric, apply a condition to it, and select an action when the condition is met.

    ![](posts/files/shipped-application-level-policy/assets/images/9.png)
